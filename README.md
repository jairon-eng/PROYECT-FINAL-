...
-------------------------------------------------------------------------------------------------------------------
# [CLICK ACA PARA VER COMO CREAR REPOSITORIOS EN DOCKER HUB](https://docs.docker.com/docker-hub/repos/)
...
```
# [CLICK ACA PARA VER COMO SE REALIZA EL SECRETO CON CREDENCIALES ](https://www.mankier.com/1/kubectl-create-secret-docker-registry)
#COMANDOS PARA CREAR UN SECRETO CON LAS CREDENCIALES DEL DOCKER HUB Y COMANDO QUE CREA UN CODIGO PARA PODER CONECTARSE AL REPOSITORIO PRIVADO DE DOCKER HUB
```
